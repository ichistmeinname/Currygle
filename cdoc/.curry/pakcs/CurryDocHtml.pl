...
'CurryDocHtml.generateHtmlDocs\'2E_\'23lambda1_8'('FlatCurry.Prog'(A,B,C,D,E),F,G,H,I,J,K,L,M,N,O):-!,makeShare(K,P),makeShare(H,Q),makeShare(C,R),makeShare(D,S),makeShare(J,T),makeShare(F,U),hnf('Prelude.return'('Prelude.$'(partcall(1,'CurryDocHtml.showDocCSS',['Prelude.++'(['^M','^o','^d','^u','^l','^e'],'Prelude.apply'('CurryDocRead.getLastName',P))]),'Prelude.++'(['HTML.h1'(['HTML.href'('Prelude.++'('Prelude.apply'('CurryDocRead.getLastName',P),['^_','^c','^u','^r','^r','^y',^.,'^h','^t','^m','^l']),['HTML.htxt'('Prelude.++'('Prelude.apply'('CurryDocRead.getLastName',P),[^.,'^c','^u','^r','^r','^y']))])])],'Prelude.++'('CurryDocHtml.genHtmlModule'(Q,I),'Prelude.++'(['HTML.HtmlStruct'(['^t','^a','^b','^l','^e'],['Prelude.(,)'(['^b','^o','^r','^d','^e','^r'],['^1']),'Prelude.(,)'(['^w','^i','^d','^t','^h'],['^1','^0','^0','^%'])],['HTML.HtmlStruct'(['^t','^r'],[],['HTML.HtmlStruct'(['^t','^d'],['Prelude.(,)'(['^v','^a','^l','^i','^g','^n'],['^t','^o','^p']),'Prelude.(,)'(['^w','^i','^d','^t','^h'],['^2','^0','^%'])],'Prelude.++'(['HTML.h2'(['HTML.htxt'(['^E','^x','^p','^o','^r','^t','^e','^d','^ ','^n','^a','^m','^e','^s',^:])])],'Prelude.++'('CurryDocHtml.genHtmlExportIndex'('CurryDocHtml.getExportedTypes'(R),'CurryDocHtml.getExportedCons'(R),'CurryDocHtml.getExportedFuns'(S)),['HTML.h2'(['HTML.htxt'(['^I','^m','^p','^o','^r','^t','^e','^d','^ ','^m','^o','^d','^u','^l','^e','^s',^:])]),'HTML.par'('Prelude.apply'('Prelude.concatMap'(partcall(1,'CurryDocHtml.generateHtmlDocs\'2E_\'23lambda1\'2E_\'23lambda2',[])),B))]))),'HTML.HtmlStruct'(['^t','^d'],[],'Prelude.++'(['HTML.h2'(['HTML.htxt'(['^S','^u','^m','^m','^a','^r','^y','^ ','^o','^f','^ ','^e','^x','^p','^o','^r','^t','^e','^d','^ ','^f','^u','^n','^c','^t','^i','^o','^n','^s',^:])]),'HTML.HtmlStruct'(['^t','^a','^b','^l','^e'],['Prelude.(,)'(['^b','^o','^r','^d','^e','^r'],['^1']),'Prelude.(,)'(['^w','^i','^d','^t','^h'],['^1','^0','^0','^%'])],'Prelude.map'(partcall(1,'CurryDocHtml.generateHtmlDocs\'2E_\'23lambda1\'2E_\'23lambda3',[]),'Prelude.apply'('Prelude.concatMap'(partcall(1,'CurryDocHtml.genHtmlFuncShort',[U,T,Q])),S)))],'Prelude.++'('CurryDocHtml.generateHtmlDocs\'2E_\'23lambda1\'2E_\'23caseor0'('Prelude.null'(R),Q,T,R),'Prelude.++'(['HTML.h2'(['HTML.htxt'(['^E','^x','^p','^o','^r','^t','^e','^d','^ ','^f','^u','^n','^c','^t','^i','^o','^n','^s',^:])]),'HTML.hrule'],'Prelude.apply'('Prelude.concatMap'(partcall(1,'CurryDocHtml.genHtmlFunc',[E,U,T,P,Q])),S)))))])])],'CurryDocHtml.curryDocEpilog'(G,L)))))),M,N,O).
...
%%%%% Number of shared variables: 105
