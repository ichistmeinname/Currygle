...
a specific context. Therefore we want to provide specifiers the user
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{Document}\;\{\mskip1.5mu \Varid{title}{}\<[19]%
\>[19]{}\mathrel{=}\Varid{fiName}\;\Varid{info},{}\<[E]%
\\
\>[19]{}\hsindent{26}{}\<[45]%
\>[45]{}\Varid{uri}{}\<[52]%
\>[52]{}\mathrel{=}\Varid{uriP},{}\<[E]%
\\
\>[19]{}\hsindent{26}{}\<[45]%
\>[45]{}\Varid{custom}\mathrel{=}\Conid{Just}\;\Varid{info}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
