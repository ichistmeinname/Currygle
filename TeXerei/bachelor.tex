...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{Inverted}{}\<[17]%
\>[17]{}\mathrel{=}\Conid{Map}\;\Conid{Pair}\;\Conid{Occurrence}{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Occurrence}\mathrel{=}\Conid{Map}\;\Conid{DocId}\;\Conid{Positions}{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Positions}{}\<[17]%
\>[17]{}\mathrel{=}\Conid{IntSet}{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{DocId}{}\<[17]%
\>[17]{}\mathrel{=}\Conid{Int}{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{Pair}{}\<[17]%
...
\ColumnHook
\end{hscode}\resethooks
\caption{Sketch for \ensuremath{\Conid{Inverted}} in Haskell syntax}
\label{fig:inverted}
\end{figure}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Pretty printing for signatures (i.e. ["Int", "Int"] -> "Int->Int")}{}\<[E]%
\\
\>[B]{}\Varid{listToSignature}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{listToSignature}\;\Varid{listOfTypes}\mathrel{=}\Varid{intercalate}\;\text{\tt \char34 ~->~\char34}\;\Varid{listOfTypes}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\newline{}\<[E]%
\\
\>[B]{}\mathbf{type}\;\Conid{HolumbusState}\;\Varid{a}{}\<[27]%
\>[27]{}\mathrel{=}\Conid{IndexerState}\;\Conid{Inverted}\;\Conid{Documents}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{contextsF}\mathbin{::}\Conid{FunctionInfo}\to \Conid{DocId}\to [\mskip1.5mu (\Conid{String},\Conid{String},\Conid{Occurrences})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{contextsF}\;\Varid{functionI}\;\Varid{i}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{map}\;(\Varid{addOcc}\;{}\<[16]%
\>[16]{}(\Varid{occ}\;\Varid{i}\;\mathrm{2}))\mathbin{\$}[\mskip1.5mu (\text{\tt \char34 :function\char34},\Varid{fName}\;\Varid{functionI})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\plus [\mskip1.5mu (\text{\tt \char34 :inModule\char34},\Varid{fModule}\;\Varid{functionI})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\plus (\Varid{signature}\mathbin{\$}\Varid{signatureComponents}\mathbin{\$}\Varid{fSignature}\;\Varid{functionI}){}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\plus (\Varid{flexRigid}\mathbin{\$}\Varid{fFlexRigid}\;\Varid{functionI}){}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\plus (\Varid{nonDet}\mathbin{\$}\Varid{fNonDet}\;\Varid{functionI}){}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\plus (\Varid{description}\mathbin{\$}\Varid{fDescription}\;\Varid{functionI}){}\<[E]%
\\
\>[B]{}\mathbf{where}\;\Varid{flexRigid}\;\Varid{fr}\mathrel{=}\mathbf{case}\;\Varid{fr}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Conid{KnownFlex}{}\<[34]%
\>[34]{}\to [\mskip1.5mu (\text{\tt \char34 :flexible\char34},\text{\tt \char34 \char34})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Conid{KnownRigid}\to [\mskip1.5mu (\text{\tt \char34 :rigid\char34},\text{\tt \char34 \char34})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Conid{ConflictFR}\to [\mskip1.5mu (\text{\tt \char34 :flexible\char34},\text{\tt \char34 \char34}),(\text{\tt \char34 :rigid\char34},\text{\tt \char34 \char34})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\anonymous {}\<[34]%
\>[34]{}\to [\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{nonDet}\;\Varid{nd}{}\<[21]%
\>[21]{}\mathrel{=}\mathbf{if}\;\Varid{nd}\;\mathbf{then}\;[\mskip1.5mu (\text{\tt \char34 :nondet\char34},\text{\tt \char34 \char34})\mskip1.5mu]\;\mathbf{else}\;[\mskip1.5mu (\text{\tt \char34 :det\char34},\text{\tt \char34 \char34})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\caption{Function to create the context list for a function}
\label{fig:contextf}
...
\column{24}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Main indexer method to build indexes and documents.}{}\<[E]%
\\
\>[B]{}\Varid{ixDoc}\mathbin{::}\Conid{Binary}\;\Varid{a}\Rightarrow (\Varid{a}\to \Conid{DocId}\to [\mskip1.5mu (\Conid{String},\Conid{String},\Conid{Occurrences})\mskip1.5mu])\to {}\<[E]%
\\
\>[B]{}\hsindent{24}{}\<[24]%
\>[24]{}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Conid{Document}\;\Varid{a}\mskip1.5mu]\to \Conid{HolumbusState}\;\Varid{a}\to \Conid{HolumbusState}\;\Varid{a}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{ixDoc}\;\anonymous \;\anonymous \;\anonymous \;\Varid{is}\mathrel{=}\Varid{is}{}\<[E]%
\\
\>[B]{}\newline{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Function to build index.}{}\<[E]%
\\
\>[B]{}\Varid{idx}\mathbin{::}(\Varid{a}\to \Conid{DocId}\to [\mskip1.5mu (\Conid{String},\Conid{String},\Conid{Occurrences})\mskip1.5mu])\to \Varid{a}\to \Conid{DocId}\to \Conid{Inverted}{}\<[E]%
\\
\>[B]{}\Varid{idx}\;\Varid{contextList}\;\Varid{info}\;\Varid{i}\mathrel{=}\Varid{fromList}\;\Varid{emptyInverted}\mathbin{\$}\Varid{contextList}\;\Varid{info}\;\Varid{i}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\caption{Method to create the \ensuremath{\Conid{HolumbusState}\;\Varid{a}} data strucutre}
\label{fig:ixdoc}
\end{figure}
