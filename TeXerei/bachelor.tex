...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{listOfFunctionInfoStructures}\mathrel{=}\Varid{functionInfos}\;\Varid{curryDoc}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
context, i.e. the string \ensuremath{\text{\tt \char34 description\char34}}, with the given data of
\ensuremath{\Varid{aFunctionInfoStructure}}, i.e. the description of a function; %
...
l\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
