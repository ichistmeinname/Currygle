...
\ensuremath{\Conid{Query}} allows to search for a word and a phrase, both
...
\ensuremath{\Conid{AND}}, \ensuremath{\Conid{OR}} and \ensuremath{\Conid{NOT}} to combine multiple
...
query. As return value, we get a data structure that consists of the
