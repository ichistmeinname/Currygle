...
\ensuremath{\Conid{FunctionInfo}} consists of characteristics for a given function. It
...
do not keep the \ensuremath{\Conid{CurryInfo}} data structure as whole for the index
...
between Curry functions, \ensuremath{\Conid{FunctionInfo}} stores these information as
...
to describe type signatures (see \hyperref[fig:typeExpr]{last
  chapter}). We use this signatures as part of the \ensuremath{\Conid{FunctionInfo}} data
structure. 
...
of \ensuremath{\Conid{TypeExpr}} in our structure. Additionally \ensuremath{\Conid{TypeInfo}} holds a list
