...
This is the information generated by CurryDoc.
-}
...
-- |This data represents a type expression consisting of
--    * a type variable with an index (Int)
--    * a function type constructed with two type expressions
--    * a type constructor with a qualified name  and a list
--      of type expressions.
data TypeExpr
  = TVar Int
